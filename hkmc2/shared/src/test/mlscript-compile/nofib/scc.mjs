...
let scc1, dfs_inst_0_tsni, stronglyConnComp_inst_1_tsni, dfs_inst_1_0_tsni, testScc_nofib_inst_2_tsni, stronglyConnComp_inst_2_1_tsni, dfs_inst_2_1_0_tsni, inList_inst_0_3_tsni, inList_inst_1_0_3_tsni, inList_inst_2_1_0_3_tsni;
dfs_inst_0_tsni = function dfs_inst_0_tsni(r, vsns, xs) {
  let first1, first0, vs, ns, param0, param1, x, xs1, scrut, first11, first01, vs$_, ns$_, scrut1, arr, arr1, tmp, arr2, tmp1, tmp2, tmp3, arr3, _deforest_Cons_head, _deforest_Cons_tail;
  if (globalThis.Array.isArray(vsns) && vsns.length === 2) {
    ...
    if (xs instanceof NofibPrelude.Nil.class) {
      ...
      x = param0;
      xs1 = param1;
      scrut1 = inList_inst_0_3_tsni(x, vs);
      if (scrut1 === true) {
        arr1 = [
          vs,
          ns
        ];
        return dfs_inst_0_tsni(r, arr1, xs1)
      } else {
        _deforest_Cons_head = x;
        _deforest_Cons_tail = vs;
        tmp = (x1) => {
          let param01, param11, h, t, scrut2;
          ...
          if (scrut2 === true) {
            ...
            return inList_inst_0_3_tsni(x1, t)
          }
        };
        arr2 = [
          tmp,
        ...
        scrut = dfs_inst_0_tsni(r, arr2, tmp1);
        if (globalThis.Array.isArray(scrut) && scrut.length === 2) {
          ...
          return dfs_inst_0_tsni(r, arr3, xs1)
        } else {
...
stronglyConnComp_inst_1_tsni = function stronglyConnComp_inst_1_tsni(es, vs) {
  ...
  span_tree = function span_tree(r, vsns, xs) {
    let first1, first0, vs1, ns, param0, param1, x, xs1, scrut, first11, first01, vs$_, ns$_, scrut1, arr2, arr3, tmp3, arr4, tmp4, tmp5, tmp6, arr5;
    if (globalThis.Array.isArray(vsns) && vsns.length === 2) {
      first0 = vsns[0];
      first1 = vsns[1];
      vs1 = first0;
  ...
  tmp = dfs_inst_1_0_tsni(lambda, arr1, vs);
...
dfs_inst_1_0_tsni = function dfs_inst_1_0_tsni(r, vsns, xs) {
  let first1, first0, vs, ns, param0, param1, x, xs1, scrut, first11, first01, vs$_, ns$_, scrut1, arr, arr1, tmp, arr2, tmp1, tmp2, tmp3, arr3, _deforest_Cons_head, _deforest_Cons_tail;
  if (globalThis.Array.isArray(vsns) && vsns.length === 2) {
    first0 = vsns[0];
    first1 = vsns[1];
    ...
    if (xs instanceof NofibPrelude.Nil.class) {
      ...
      x = param0;
      xs1 = param1;
      scrut1 = inList_inst_1_0_3_tsni(x, vs);
      if (scrut1 === true) {
        arr1 = [
          vs,
          ns
        ];
        return dfs_inst_1_0_tsni(r, arr1, xs1)
      } else {
        _deforest_Cons_head = x;
        _deforest_Cons_tail = vs;
        tmp = (x1) => {
          ...
          if (scrut2 === true) {
            ...
            return inList_inst_1_0_3_tsni(x1, t)
          }
        };
        arr2 = [
          tmp,
        ...
        tmp1 = runtime.safeCall(r(x));
        scrut = dfs_inst_1_0_tsni(r, arr2, tmp1);
        if (globalThis.Array.isArray(scrut) && scrut.length === 2) {
          first01 = scrut[0];
          first11 = scrut[1];
          vs$_ = first01;
          ...
          return dfs_inst_1_0_tsni(r, arr3, xs1)
        } else {
          throw new globalThis.Error("match error");
        }
      }
...
testScc_nofib_inst_2_tsni = function testScc_nofib_inst_2_tsni(d) {
  ...
  edges = tmp16;
  return stronglyConnComp_inst_2_1_tsni(edges, vertices)
};
stronglyConnComp_inst_2_1_tsni = function stronglyConnComp_inst_2_1_tsni(es, vs) {
  let swap, span_tree, new_range, arr, arr1, tmp, tmp1, tmp2, lambda, lambda1;
  swap = function swap(a) {
    let first1, first0, f, s, arr2;
    if (globalThis.Array.isArray(a) && a.length === 2) {
  ...
  tmp = dfs_inst_2_1_0_tsni(lambda, arr1, vs);
  tmp1 = NofibPrelude.snd(tmp);
  lambda1 = (undefined, function (x) {
    let tmp3;
    tmp3 = NofibPrelude.map(swap, es);
...
dfs_inst_2_1_0_tsni = function dfs_inst_2_1_0_tsni(r, vsns, xs) {
  let first1, first0, vs, ns, param0, param1, x, xs1, scrut, first11, first01, vs$_, ns$_, scrut1, arr, arr1, tmp, arr2, tmp1, tmp2, tmp3, arr3, _deforest_Cons_head, _deforest_Cons_tail;
  if (globalThis.Array.isArray(vsns) && vsns.length === 2) {
    first0 = vsns[0];
    first1 = vsns[1];
    ...
    if (xs instanceof NofibPrelude.Nil.class) {
      ...
      x = param0;
      xs1 = param1;
      scrut1 = inList_inst_2_1_0_3_tsni(x, vs);
      if (scrut1 === true) {
        arr1 = [
          vs,
          ns
        ];
        return dfs_inst_2_1_0_tsni(r, arr1, xs1)
      } else {
        _deforest_Cons_head = x;
        _deforest_Cons_tail = vs;
        tmp = (x1) => {
          ...
          if (scrut2 === true) {
            ...
            return inList_inst_2_1_0_3_tsni(x1, t)
          }
        };
        arr2 = [
          tmp,
        ...
        tmp1 = runtime.safeCall(r(x));
        scrut = dfs_inst_2_1_0_tsni(r, arr2, tmp1);
        if (globalThis.Array.isArray(scrut) && scrut.length === 2) {
          first01 = scrut[0];
          first11 = scrut[1];
          vs$_ = first01;
          ...
          return dfs_inst_2_1_0_tsni(r, arr3, xs1)
        } else {
          throw new globalThis.Error("match error");
        }
      }
...
inList_inst_0_3_tsni = function inList_inst_0_3_tsni(x, ls) {
  return runtime.safeCall(ls(x))
};
inList_inst_1_0_3_tsni = function inList_inst_1_0_3_tsni(x, ls) {
  return runtime.safeCall(ls(x))
};
inList_inst_2_1_0_3_tsni = function inList_inst_2_1_0_3_tsni(x, ls) {
  return runtime.safeCall(ls(x))
};
(class scc {
  static {
  ...
  static stronglyConnComp(es, vs) {
    ...
    tmp = dfs_inst_0_tsni(lambda, arr1, vs);
    tmp1 = NofibPrelude.snd(tmp);
    lambda1 = (undefined, function (x) {
      let tmp3;
      tmp3 = NofibPrelude.map(swap, es);
  ...
  static testScc_nofib(d) {
    ...
    tmp16 = NofibPrelude.Cons(arr, tmp15);
    edges = tmp16;
    return stronglyConnComp_inst_1_tsni(edges, vertices)
  } 
  static main() {
    let tmp;
    tmp = testScc_nofib_inst_2_tsni(0);
