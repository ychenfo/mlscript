...
let treejoin1, join_inst_0_tsni, lookupT_inst_0_1_tsni, join_inst_2_tsni, lookupT_inst_2_1_tsni, lookupT_inst_1_tsni, join_inst_3_tsni, lookupT_inst_3_1_tsni, testTreejoin_nofib_inst_4_tsni, join_inst_4_3_tsni, lookupT_inst_4_3_1_tsni, match_scrut_arm_None_inst_0_tsni, match_scrut_arm_None_inst_2_tsni, match_scrut_arm_None_inst__tsni, match_scrut_arm_None_inst_3_tsni, match_scrut_arm_None_inst_4_3_tsni;
...
match_scrut_arm_None_inst_3_tsni = function match_scrut_arm_None_inst_3_tsni(j, a, b, c) {
  return j
};
match_scrut_arm_None_inst_4_3_tsni = function match_scrut_arm_None_inst_4_3_tsni(j, a, b, c) {
  return j
};
...
join_inst_3_tsni = function join_inst_3_tsni(t1, t2, j) {
  let param0, param1, param2, k, l, r, k1, first2, first1, first0, a, b, c, scrut, tmp;
  if (t1 instanceof treejoin.Empty.class) {
    return j
  } else {
    if (t2 instanceof treejoin.Empty.class) {
      ...
      if (t1 instanceof treejoin.Leaf.class) {
        ...
        if (globalThis.Array.isArray(param1) && param1.length === 3) {
          ...
          b = first1;
          c = first2;
          scrut = lookupT_inst_3_1_tsni(c, t2);
          return runtime.safeCall(scrut(j, a, b, c))
        } else {
          throw new globalThis.Error("match error");
        }
        ...
        l = param1;
        r = param2;
        tmp = join_inst_3_tsni(r, t2, j);
        return join_inst_3_tsni(l, t2, tmp)
      } else {
        throw new globalThis.Error("match error");
      }
    }
...
lookupT_inst_3_1_tsni = function lookupT_inst_3_1_tsni(k, t) {
  let param0, param1, k_, e, scrut, param2, k_1, l, r, scrut1, _deforest_Some_x;
  if (t instanceof treejoin.Node.class) {
    param0 = t.k;
    param1 = t.l;
    ...
    scrut1 = k <= k_1;
    if (scrut1 === true) {
      return lookupT_inst_3_1_tsni(k, l)
    } else {
      return lookupT_inst_3_1_tsni(k, r)
    }
  } else if (t instanceof treejoin.Leaf.class) {
    param0 = t.k;
    param1 = t.e;
    ...
    if (scrut === true) {
      ...
      return (j, a, b, c) => {
        return match_scrut_arm_None_inst_3_tsni(j, a, b, c)
      }
    }
  } else if (t instanceof treejoin.Empty.class) {
    return (j, a, b, c) => {
...
testTreejoin_nofib_inst_4_tsni = function testTreejoin_nofib_inst_4_tsni(n) {
  ...
  tmp6 = lambda;
  tmp7 = treejoin.readTree(tmp6, c1, treejoin.Empty);
  a = tmp7;
  ...
  b = tmp9;
  return join_inst_4_3_tsni(a, b, treejoin.Empty)
};
join_inst_4_3_tsni = function join_inst_4_3_tsni(t1, t2, j) {
  let param0, param1, param2, k, l, r, k1, first2, first1, first0, a, b, c, scrut, tmp;
  if (t1 instanceof treejoin.Empty.class) {
    return j
  } else {
    if (t2 instanceof treejoin.Empty.class) {
      ...
      if (t1 instanceof treejoin.Leaf.class) {
        ...
        if (globalThis.Array.isArray(param1) && param1.length === 3) {
          ...
          b = first1;
          c = first2;
          scrut = lookupT_inst_4_3_1_tsni(c, t2);
          return runtime.safeCall(scrut(j, a, b, c))
        } else {
          throw new globalThis.Error("match error");
        }
        ...
        l = param1;
        r = param2;
        tmp = join_inst_4_3_tsni(r, t2, j);
        return join_inst_4_3_tsni(l, t2, tmp)
      } else {
        throw new globalThis.Error("match error");
      }
    }
...
lookupT_inst_4_3_1_tsni = function lookupT_inst_4_3_1_tsni(k, t) {
  let param0, param1, k_, e, scrut, param2, k_1, l, r, scrut1, _deforest_Some_x;
  if (t instanceof treejoin.Node.class) {
    param0 = t.k;
    param1 = t.l;
    ...
    scrut1 = k <= k_1;
    if (scrut1 === true) {
      return lookupT_inst_4_3_1_tsni(k, l)
    } else {
      return lookupT_inst_4_3_1_tsni(k, r)
    }
  } else if (t instanceof treejoin.Leaf.class) {
    param0 = t.k;
    param1 = t.e;
    ...
    if (scrut === true) {
      ...
      return (j, a, b, c) => {
        return match_scrut_arm_None_inst_4_3_tsni(j, a, b, c)
      }
    }
  } else if (t instanceof treejoin.Empty.class) {
    return (j, a, b, c) => {
...
(class treejoin {
  ...
  static readTree(fk, s1, t3) {
    let scrut, first1, first0, f, s_, scrut1, first11, first01, g, s__, scrut2, first12, first02, h, s___, e1, k2, arr, tmp, tmp1;
  ...
  static testTreejoin_nofib(n) {
    ...
    tmp9 = treejoin.readTree(tmp8, c2, treejoin.Empty);
    b = tmp9;
    return join_inst_3_tsni(a, b, treejoin.Empty)
  } 
  static main() {
    let tmp;
    tmp = testTreejoin_nofib_inst_4_tsni(0);
