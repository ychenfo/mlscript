...
let cse1, map_inst_0_tsni, ltGraph_inst_1_tsni, map_inst_1_0_tsni, fetch_inst_2_tsni, ltGraph_inst_3_tsni, map_inst_3_0_tsni, enumFromTo_inst_4_tsni, testCse_nofib_inst_5_tsni, cse_inst_5_6_tsni, ltGraph_inst_5_6_3_tsni, map_inst_5_6_3_0_tsni, take_inst_5_7_tsni, prod_inst_8_tsni, plus__inst_9_tsni, prod_inst_10_tsni, plus__inst_11_tsni, plus__inst_12_tsni, mult__inst_13_tsni, plus__inst_14_tsni, plus__inst_15_tsni, plus__inst_16_tsni, mult__inst_17_tsni, mult__inst_18_tsni, plus__inst_19_tsni, enumFromTo_inst_5_4_tsni, scanr_inst_20_tsni, scanl_inst_21_tsni, concat_inst_22_tsni, concat_inst_1_22_tsni, bind_inst_23_tsni, concat_inst_3_22_tsni, map_inst_24_tsni, concat_inst_5_6_3_22_tsni, map_inst_5_25_tsni, labelTree_inst_5_6_26_tsni, map_inst_5_24_tsni, match_ls_arm_Cons_inst_20_tsni, match_ls_arm_Cons_inst_21_tsni, match_ls_arm_Cons_inst_5_7_tsni, match_xs_arm_Nil_inst_5_25_tsni, match_t_arm_Node_inst_5_6_26_tsni;
match_ls_arm_Cons_inst_20_tsni = function match_ls_arm_Cons_inst_20_tsni(f, q, _deforest_Cons_head_inst_20_tsni, _deforest_Cons_tail_inst_20_tsni) {
  let param0, param1, x, xs, scrut, param01, param11, q1, t, tmp, tmp1;
  param0 = _deforest_Cons_head_inst_20_tsni;
  param1 = _deforest_Cons_tail_inst_20_tsni;
  x = param0;
  xs = param1;
  scrut = scanr_inst_20_tsni(f, q, xs);
...
match_ls_arm_Cons_inst_21_tsni = function match_ls_arm_Cons_inst_21_tsni(f, q, _deforest_Cons_head_inst_21_tsni, _deforest_Cons_tail_inst_21_tsni) {
  ...
  tmp1 = scanl_inst_21_tsni(f, tmp, xs);
...
match_ls_arm_Cons_inst_5_7_tsni = function match_ls_arm_Cons_inst_5_7_tsni(n, _deforest_Cons_head_inst_5_7_tsni, _deforest_Cons_tail_inst_5_7_tsni) {
  ...
  if (scrut === true) {
    return (f) => {
      return match_xs_arm_Nil_inst_5_25_tsni(f)
    }
  } else {
    tmp = n - 1;
    ...
    return (f) => {
      ...
      tmp3 = map_inst_5_25_tsni(f, xs);
      return NofibPrelude.Cons(tmp2, tmp3)
    }
  }
};
match_xs_arm_Nil_inst_5_25_tsni = function match_xs_arm_Nil_inst_5_25_tsni(f) {
  return NofibPrelude.Nil
};
match_t_arm_Node_inst_5_6_26_tsni = function match_t_arm_Node_inst_5_6_26_tsni(label, _deforest_Node_a_inst_5_6_26_tsni, _deforest_Node_b_inst_5_6_26_tsni) {
  let param0, param1, x, xs, lambda;
  param0 = _deforest_Node_a_inst_5_6_26_tsni;
  param1 = _deforest_Node_b_inst_5_6_26_tsni;
  x = param0;
  xs = param1;
  lambda = (undefined, function (n) {
    let tmp, tmp1, lambda1;
    tmp = cse.mmapl(label, xs);
    lambda1 = (undefined, function (ts) {
      ...
      tmp2 = cse.Node(arr, ts);
      return cse.retURN(tmp2)
    });
    tmp1 = lambda1;
    return cse.bind(tmp, tmp1)
  });
...
ltGraph_inst_1_tsni = function ltGraph_inst_1_tsni(t) {
  ...
  if (t instanceof cse.Node.class) {
    ...
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      ...
      tmp2 = concat_inst_1_22_tsni(tmp1);
...
ltGraph_inst_3_tsni = function ltGraph_inst_3_tsni(t) {
  ...
  if (t instanceof cse.Node.class) {
    ...
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      ...
      tmp2 = concat_inst_3_22_tsni(tmp1);
      return NofibPrelude.Cons(arr, tmp2)
    } else {
      throw new globalThis.Error("match error");
    }
...
map_inst_3_0_tsni = function map_inst_3_0_tsni(f, xs) {
  ...
  if (xs instanceof NofibPrelude.Cons.class) {
    ...
    return () => {
      ...
      x1 = param01;
      xs2 = param11;
      tmp2 = concat_inst_3_22_tsni(xs2);
      return NofibPrelude.append(x1, tmp2)
    }
  } else if (xs instanceof NofibPrelude.Nil.class) {
    return () => {
...
testCse_nofib_inst_5_tsni = function testCse_nofib_inst_5_tsni(n) {
  ...
  lambda = (undefined, function (i) {
    ...
    return map_inst_5_25_tsni(cse_inst_5_6_tsni, tmp9)
  });
  tmp = lambda;
  tmp1 = enumFromTo_inst_5_4_tsni(1, n);
  return map_inst_5_24_tsni(tmp, tmp1)
};
cse_inst_5_6_tsni = function cse_inst_5_6_tsni(t) {
  let tmp, tmp1;
  tmp = labelTree_inst_5_6_26_tsni(t);
...
ltGraph_inst_5_6_3_tsni = function ltGraph_inst_5_6_3_tsni(t) {
  ...
  if (t instanceof cse.Node.class) {
    ...
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      ...
      tmp2 = concat_inst_5_6_3_22_tsni(tmp1);
      return NofibPrelude.Cons(arr, tmp2)
    } else {
      throw new globalThis.Error("match error");
    }
...
map_inst_5_6_3_0_tsni = function map_inst_5_6_3_0_tsni(f, xs) {
  ...
  if (xs instanceof NofibPrelude.Cons.class) {
    ...
    return () => {
      ...
      x1 = param01;
      xs2 = param11;
      tmp2 = concat_inst_5_6_3_22_tsni(xs2);
      return NofibPrelude.append(x1, tmp2)
    }
  } else if (xs instanceof NofibPrelude.Nil.class) {
    return () => {
...
prod_inst_8_tsni = function prod_inst_8_tsni(xs) {
  let _deforest_Node_a, _deforest_Node_b;
  _deforest_Node_a = "X";
  _deforest_Node_b = xs;
  return (label) => {
    return match_t_arm_Node_inst_5_6_26_tsni(label, _deforest_Node_a, _deforest_Node_b)
  }
};
plus__inst_9_tsni = function plus__inst_9_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "+";
  _deforest_Node_b = tmp1;
  return (label) => {
    return match_t_arm_Node_inst_5_6_26_tsni(label, _deforest_Node_a, _deforest_Node_b)
  }
};
prod_inst_10_tsni = function prod_inst_10_tsni(xs) {
  let _deforest_Node_a, _deforest_Node_b;
  _deforest_Node_a = "X";
  _deforest_Node_b = xs;
  return (label) => {
...
plus__inst_11_tsni = function plus__inst_11_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "+";
...
plus__inst_12_tsni = function plus__inst_12_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "+";
...
mult__inst_13_tsni = function mult__inst_13_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "*";
...
plus__inst_14_tsni = function plus__inst_14_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "+";
...
plus__inst_15_tsni = function plus__inst_15_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "+";
...
plus__inst_16_tsni = function plus__inst_16_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "+";
...
mult__inst_17_tsni = function mult__inst_17_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "*";
...
mult__inst_18_tsni = function mult__inst_18_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "*";
...
plus__inst_19_tsni = function plus__inst_19_tsni(x, y) {
  let tmp, tmp1, _deforest_Node_a, _deforest_Node_b;
  tmp = NofibPrelude.Cons(y, NofibPrelude.Nil);
  tmp1 = NofibPrelude.Cons(x, tmp);
  _deforest_Node_a = "+";
...
scanr_inst_20_tsni = function scanr_inst_20_tsni(f, q, ls) {
  return runtime.safeCall(ls(f, q))
};
scanl_inst_21_tsni = function scanl_inst_21_tsni(f, q, ls) {
  return runtime.safeCall(ls(f, q))
};
...
bind_inst_23_tsni = function bind_inst_23_tsni(m, f) {
  let lambda;
...
concat_inst_3_22_tsni = function concat_inst_3_22_tsni(ls) {
  return runtime.safeCall(ls())
};
map_inst_24_tsni = function map_inst_24_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
concat_inst_5_6_3_22_tsni = function concat_inst_5_6_3_22_tsni(ls) {
  return runtime.safeCall(ls())
};
map_inst_5_25_tsni = function map_inst_5_25_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
labelTree_inst_5_6_26_tsni = function labelTree_inst_5_6_26_tsni(t) {
  let label, tmp;
  label = function label(t1) {
    return runtime.safeCall(t1(label))
  };
  tmp = label(t);
  return cse.startingWith(tmp, 0)
};
map_inst_5_24_tsni = function map_inst_5_24_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
(class cse {
  static {
    cse1 = cse;
    let tmp, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7, tmp8, tmp9, tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16, tmp17, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, lambda, _deforest_Cons_head, _deforest_Cons_tail, _deforest_Cons_head1, _deforest_Cons_tail1, _deforest_Cons_head2, _deforest_Cons_tail2, _deforest_Cons_head3, _deforest_Cons_tail3, _deforest_Cons_head4, _deforest_Cons_tail4, _deforest_Cons_head5, _deforest_Cons_tail5, _deforest_Cons_head6, _deforest_Cons_tail6, _deforest_Cons_head7, _deforest_Cons_tail7, _deforest_Node_a, _deforest_Node_b, _deforest_Node_a1, _deforest_Node_b1, _deforest_Node_a2, _deforest_Node_b2, _deforest_Node_a3, _deforest_Node_b3, _deforest_Node_a4, _deforest_Node_b4;
    ...
    _deforest_Node_a4 = "0";
    _deforest_Node_b4 = NofibPrelude.Nil;
    tmp1 = (label) => {
      return match_t_arm_Node_inst_5_6_26_tsni(label, _deforest_Node_a4, _deforest_Node_b4)
    };
    this.zerO = tmp1;
    _deforest_Node_a = "a";
    _deforest_Node_b = NofibPrelude.Nil;
    tmp2 = (label) => {
      return match_t_arm_Node_inst_5_6_26_tsni(label, _deforest_Node_a, _deforest_Node_b)
    };
    this.a = tmp2;
    _deforest_Node_a1 = "b";
    _deforest_Node_b1 = NofibPrelude.Nil;
    tmp3 = (label) => {
      return match_t_arm_Node_inst_5_6_26_tsni(label, _deforest_Node_a1, _deforest_Node_b1)
    };
    this.b = tmp3;
    _deforest_Node_a2 = "c";
    _deforest_Node_b2 = NofibPrelude.Nil;
    tmp4 = (label) => {
      return match_t_arm_Node_inst_5_6_26_tsni(label, _deforest_Node_a2, _deforest_Node_b2)
    };
    this.c = tmp4;
    _deforest_Node_a3 = "d";
    _deforest_Node_b3 = NofibPrelude.Nil;
    tmp5 = (label) => {
      return match_t_arm_Node_inst_5_6_26_tsni(label, _deforest_Node_a3, _deforest_Node_b3)
    };
    this.d = tmp5;
    this.example0 = cse.a;
    tmp6 = plus__inst_19_tsni(cse.a, cse.a);
    this.example1 = tmp6;
    tmp7 = mult__inst_17_tsni(cse.a, cse.b);
    tmp8 = mult__inst_18_tsni(cse.a, cse.b);
    tmp9 = plus__inst_16_tsni(tmp7, tmp8);
    this.example2 = tmp9;
    tmp10 = plus__inst_14_tsni(cse.a, cse.b);
    tmp11 = mult__inst_13_tsni(tmp10, cse.c);
    tmp12 = plus__inst_15_tsni(cse.a, cse.b);
    tmp13 = plus__inst_12_tsni(tmp11, tmp12);
    this.example3 = tmp13;
    ...
    tmp14 = (f, q) => {
      return match_ls_arm_Cons_inst_21_tsni(f, q, _deforest_Cons_head7, _deforest_Cons_tail7)
    };
    _deforest_Cons_head6 = cse.c;
    _deforest_Cons_tail6 = tmp14;
    tmp15 = (f, q) => {
      return match_ls_arm_Cons_inst_21_tsni(f, q, _deforest_Cons_head6, _deforest_Cons_tail6)
    };
    _deforest_Cons_head5 = cse.b;
    _deforest_Cons_tail5 = tmp15;
    tmp16 = (f, q) => {
      return match_ls_arm_Cons_inst_21_tsni(f, q, _deforest_Cons_head5, _deforest_Cons_tail5)
    };
    _deforest_Cons_head4 = cse.a;
    _deforest_Cons_tail4 = tmp16;
    tmp17 = (f, q) => {
      return match_ls_arm_Cons_inst_21_tsni(f, q, _deforest_Cons_head4, _deforest_Cons_tail4)
    };
    tmp18 = scanl_inst_21_tsni(plus__inst_11_tsni, cse.zerO, tmp17);
    tmp19 = prod_inst_10_tsni(tmp18);
    this.example4 = tmp19;
    ...
    tmp20 = (f, q) => {
      return match_ls_arm_Cons_inst_20_tsni(f, q, _deforest_Cons_head3, _deforest_Cons_tail3)
    };
    _deforest_Cons_head2 = cse.c;
    _deforest_Cons_tail2 = tmp20;
    tmp21 = (f, q) => {
      return match_ls_arm_Cons_inst_20_tsni(f, q, _deforest_Cons_head2, _deforest_Cons_tail2)
    };
    _deforest_Cons_head1 = cse.b;
    _deforest_Cons_tail1 = tmp21;
    tmp22 = (f, q) => {
      return match_ls_arm_Cons_inst_20_tsni(f, q, _deforest_Cons_head1, _deforest_Cons_tail1)
    };
    _deforest_Cons_head = cse.a;
    _deforest_Cons_tail = tmp22;
    tmp23 = (f, q) => {
      return match_ls_arm_Cons_inst_20_tsni(f, q, _deforest_Cons_head, _deforest_Cons_tail)
    };
    tmp24 = scanr_inst_20_tsni(plus__inst_9_tsni, cse.zerO, tmp23);
    tmp25 = prod_inst_8_tsni(tmp24);
    this.example5 = tmp25;
  }
  static retURN(a) {
    let lambda;
  ...
  static visited(n) {
    ...
    tmp = lambda;
    return bind_inst_23_tsni(fetch_inst_2_tsni, tmp)
  } 
  ...
  static findCommon(ls) {
    let sim, scrut, arr, lambda, _deforest_Deforest_Arr_2_0, _deforest_Deforest_Arr_2_1;
    sim = function sim(n_s_cs, r_lg) {
      let lscomp, first2, first1, first0, n1, s1, cs, first11, first01, r, lg, rcs, ms, scrut1, tmp, tmp1, arr1, tmp2, arr2, arr3, lambda1;
      if (globalThis.Array.isArray(n_s_cs) && n_s_cs.length === 3) {
        ...
        if (globalThis.Array.isArray(r_lg) && r_lg.length === 2) {
          ...
          lscomp = function lscomp(ls1) {
            let param0, param1, first21, first12, first02, m4, s_1, cs_, t3, scrut2, scrut3, tmp3;
            if (ls1 instanceof NofibPrelude.Nil.class) {
              ...
              if (globalThis.Array.isArray(param0) && param0.length === 3) {
                ...
                if (scrut2 === true) {
                  ...
                  if (scrut3 === true) {
                    tmp3 = lscomp(t3);
                    return NofibPrelude.Cons(m4, tmp3)
                  } else {
                    return lscomp(t3)
                  }
                } else {
          ...
          if (scrut1 === true) {
            ...
            tmp2 = NofibPrelude.Cons(arr1, lg);
            arr2 = [
              r,
              tmp2
            ];
            ...
            lambda1 = (undefined, function (x1) {
              let tmp3;
              tmp3 = NofibPrelude.head(ms);
              return cse.newlyDefined(n1, tmp3, r, x1)
            });
            arr3 = [
              lambda1,
              lg
    ...
    _deforest_Deforest_Arr_2_0 = lambda;
    _deforest_Deforest_Arr_2_1 = NofibPrelude.Nil;
    arr = (ls1) => {
      let first1, first0, a3, b;
      first0 = _deforest_Deforest_Arr_2_0;
      first1 = _deforest_Deforest_Arr_2_1;
      a3 = first0;
      b = first1;
    ...
    return runtime.safeCall(scrut(ls))
  } 
  static cse(t3) {
    let tmp, tmp1;
  ...
  static testCse_nofib(n1) {
    ...
    return map_inst_24_tsni(tmp, tmp1)
  } 
  static main() {
    let tmp;
