...
let cse1, map_inst_0_1_tsni, set__inst_2_3_tsni, fetch_inst_2_4_tsni, ltGraph_inst_5_6_tsni, map_inst_5_6_1_tsni, cse_inst_7_8_tsni, ltGraph_inst_7_8_6_tsni, map_inst_7_8_6_1_tsni, take_inst_7_9_tsni, enumFromTo_inst_7_10_tsni, testCse_nofib_inst_11_12_tsni, enumFromTo_inst_11_12_10_tsni, cse_inst_11_12_8_tsni, ltGraph_inst_11_12_8_6_tsni, map_inst_11_12_8_6_1_tsni, take_inst_11_12_9_tsni, scanr_inst_13_tsni, scanl_inst_14_tsni, concat_inst_0_15_tsni, bind_inst_2_16_tsni, bind_inst_2_17_tsni, concat_inst_5_6_15_tsni, concat_inst_7_8_6_15_tsni, map_inst_7_18_tsni, map_inst_7_19_tsni, map_inst_11_12_19_tsni, concat_inst_11_12_8_6_15_tsni, map_inst_11_12_18_tsni, match_ls_arm_Cons_inst_13_tsni, match_ls_arm_Cons_inst_14_tsni, match_ls_arm_Cons_inst_7_9_tsni, match_xs_arm_Nil_inst_7_18_tsni, match_xs_arm_Nil_inst_11_12_18_tsni, match_ls_arm_Cons_inst_11_12_9_tsni;
match_ls_arm_Cons_inst_13_tsni = function match_ls_arm_Cons_inst_13_tsni(f, q, _deforest_Cons_head_inst_13_tsni, _deforest_Cons_tail_inst_13_tsni) {
  let param0, param1, x, xs, scrut, param01, param11, q1, t, tmp, tmp1;
  param0 = _deforest_Cons_head_inst_13_tsni;
  param1 = _deforest_Cons_tail_inst_13_tsni;
  x = param0;
  xs = param1;
  scrut = scanr_inst_13_tsni(f, q, xs);
...
match_ls_arm_Cons_inst_14_tsni = function match_ls_arm_Cons_inst_14_tsni(f, q, _deforest_Cons_head_inst_14_tsni, _deforest_Cons_tail_inst_14_tsni) {
  ...
  tmp1 = scanl_inst_14_tsni(f, tmp, xs);
  return NofibPrelude.Cons(q, tmp1)
};
match_ls_arm_Cons_inst_7_9_tsni = function match_ls_arm_Cons_inst_7_9_tsni(n, _deforest_Cons_head_inst_7_9_tsni, _deforest_Cons_tail_inst_7_9_tsni) {
  let param0, param1, h, t, scrut, tmp, tmp1, _deforest_Cons_head, _deforest_Cons_tail;
  param0 = _deforest_Cons_head_inst_7_9_tsni;
  param1 = _deforest_Cons_tail_inst_7_9_tsni;
  h = param0;
  t = param1;
  scrut = n <= 0;
  if (scrut === true) {
    return (f) => {
      return match_xs_arm_Nil_inst_7_18_tsni(f)
    }
  } else {
    tmp = n - 1;
    tmp1 = take_inst_7_9_tsni(tmp, t);
    ...
    return (f) => {
      ...
      tmp3 = map_inst_7_18_tsni(f, xs);
      return NofibPrelude.Cons(tmp2, tmp3)
    }
  }
};
match_xs_arm_Nil_inst_7_18_tsni = function match_xs_arm_Nil_inst_7_18_tsni(f) {
  return NofibPrelude.Nil
};
match_xs_arm_Nil_inst_11_12_18_tsni = function match_xs_arm_Nil_inst_11_12_18_tsni(f) {
  return NofibPrelude.Nil
};
match_ls_arm_Cons_inst_11_12_9_tsni = function match_ls_arm_Cons_inst_11_12_9_tsni(n, _deforest_Cons_head_inst_11_12_9_tsni, _deforest_Cons_tail_inst_11_12_9_tsni) {
  let param0, param1, h, t, scrut, tmp, tmp1, _deforest_Cons_head, _deforest_Cons_tail;
  param0 = _deforest_Cons_head_inst_11_12_9_tsni;
  param1 = _deforest_Cons_tail_inst_11_12_9_tsni;
  h = param0;
  t = param1;
  scrut = n <= 0;
  if (scrut === true) {
    return (f) => {
      return match_xs_arm_Nil_inst_11_12_18_tsni(f)
    }
  } else {
    tmp = n - 1;
    tmp1 = take_inst_11_12_9_tsni(tmp, t);
    _deforest_Cons_head = h;
    _deforest_Cons_tail = tmp1;
    return (f) => {
      let param01, param11, x, xs, tmp2, tmp3;
      ...
      xs = param11;
      tmp2 = runtime.safeCall(f(x));
      tmp3 = map_inst_11_12_18_tsni(f, xs);
      return NofibPrelude.Cons(tmp2, tmp3)
    }
  }
};
map_inst_0_1_tsni = function map_inst_0_1_tsni(f, xs) {
  ...
  if (xs instanceof NofibPrelude.Cons.class) {
    ...
    return () => {
      ...
      x1 = param01;
      xs2 = param11;
      tmp2 = concat_inst_0_15_tsni(xs2);
...
set__inst_2_3_tsni = function set__inst_2_3_tsni(s_) {
  let lambda;
...
fetch_inst_2_4_tsni = function fetch_inst_2_4_tsni(s) {
  let arr, _deforest_Deforest_Arr_2_0, _deforest_Deforest_Arr_2_1;
...
ltGraph_inst_5_6_tsni = function ltGraph_inst_5_6_tsni(t) {
  ...
  if (t instanceof cse.Node.class) {
    ...
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      ...
      tmp1 = map_inst_5_6_1_tsni(ltGraph_inst_5_6_tsni, xs);
      tmp2 = concat_inst_5_6_15_tsni(tmp1);
...
map_inst_5_6_1_tsni = function map_inst_5_6_1_tsni(f, xs) {
  let param0, param1, x, xs1, tmp, tmp1, _deforest_Cons_head, _deforest_Cons_tail;
  if (xs instanceof NofibPrelude.Cons.class) {
    param0 = xs.head;
    param1 = xs.tail;
    ...
    xs1 = param1;
    tmp = runtime.safeCall(f(x));
    tmp1 = map_inst_5_6_1_tsni(f, xs1);
    _deforest_Cons_head = tmp;
    _deforest_Cons_tail = tmp1;
    return () => {
      let param01, param11, x1, xs2, tmp2;
      ...
      x1 = param01;
      xs2 = param11;
      tmp2 = concat_inst_5_6_15_tsni(xs2);
      return NofibPrelude.append(x1, tmp2)
    }
  } else if (xs instanceof NofibPrelude.Nil.class) {
    return () => {
...
cse_inst_7_8_tsni = function cse_inst_7_8_tsni(t) {
  let tmp, tmp1;
  tmp = cse.labelTree(t);
  tmp1 = ltGraph_inst_7_8_6_tsni(tmp);
  return cse.findCommon(tmp1)
};
ltGraph_inst_7_8_6_tsni = function ltGraph_inst_7_8_6_tsni(t) {
  let labelOf, param0, param1, first1, first0, n, x, xs, tmp, arr, tmp1, tmp2;
  labelOf = function labelOf(t1) {
    let param01, param11, first11, first01, n1, x1, xs1;
    if (t1 instanceof cse.Node.class) {
  ...
  if (t instanceof cse.Node.class) {
    ...
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      ...
      tmp1 = map_inst_7_8_6_1_tsni(ltGraph_inst_7_8_6_tsni, xs);
      tmp2 = concat_inst_7_8_6_15_tsni(tmp1);
      return NofibPrelude.Cons(arr, tmp2)
    } else {
      throw new globalThis.Error("match error");
    }
...
map_inst_7_8_6_1_tsni = function map_inst_7_8_6_1_tsni(f, xs) {
  let param0, param1, x, xs1, tmp, tmp1, _deforest_Cons_head, _deforest_Cons_tail;
  if (xs instanceof NofibPrelude.Cons.class) {
    param0 = xs.head;
    param1 = xs.tail;
    ...
    xs1 = param1;
    tmp = runtime.safeCall(f(x));
    tmp1 = map_inst_7_8_6_1_tsni(f, xs1);
    _deforest_Cons_head = tmp;
    _deforest_Cons_tail = tmp1;
    return () => {
      let param01, param11, x1, xs2, tmp2;
      ...
      x1 = param01;
      xs2 = param11;
      tmp2 = concat_inst_7_8_6_15_tsni(xs2);
      return NofibPrelude.append(x1, tmp2)
    }
  } else if (xs instanceof NofibPrelude.Nil.class) {
    return () => {
...
take_inst_7_9_tsni = function take_inst_7_9_tsni(n, ls) {
  return runtime.safeCall(ls(n))
};
enumFromTo_inst_7_10_tsni = function enumFromTo_inst_7_10_tsni(a, b) {
  let scrut, tmp, tmp1, _deforest_Cons_head, _deforest_Cons_tail;
  scrut = a <= b;
  if (scrut === true) {
    tmp = a + 1;
    tmp1 = enumFromTo_inst_7_10_tsni(tmp, b);
...
testCse_nofib_inst_11_12_tsni = function testCse_nofib_inst_11_12_tsni(n) {
  let tmp, tmp1, lambda;
  lambda = (undefined, function (i) {
    ...
    tmp3 = (n1) => {
      return match_ls_arm_Cons_inst_11_12_9_tsni(n1, _deforest_Cons_head5, _deforest_Cons_tail5)
    };
    _deforest_Cons_head4 = cse.example4;
    _deforest_Cons_tail4 = tmp3;
    tmp4 = (n1) => {
      return match_ls_arm_Cons_inst_11_12_9_tsni(n1, _deforest_Cons_head4, _deforest_Cons_tail4)
    };
    _deforest_Cons_head3 = cse.example3;
    _deforest_Cons_tail3 = tmp4;
    tmp5 = (n1) => {
      return match_ls_arm_Cons_inst_11_12_9_tsni(n1, _deforest_Cons_head3, _deforest_Cons_tail3)
    };
    _deforest_Cons_head2 = cse.example2;
    _deforest_Cons_tail2 = tmp5;
    tmp6 = (n1) => {
      return match_ls_arm_Cons_inst_11_12_9_tsni(n1, _deforest_Cons_head2, _deforest_Cons_tail2)
    };
    _deforest_Cons_head1 = cse.example1;
    _deforest_Cons_tail1 = tmp6;
    tmp7 = (n1) => {
      return match_ls_arm_Cons_inst_11_12_9_tsni(n1, _deforest_Cons_head1, _deforest_Cons_tail1)
    };
    _deforest_Cons_head = cse.example0;
    _deforest_Cons_tail = tmp7;
    tmp8 = (n1) => {
      return match_ls_arm_Cons_inst_11_12_9_tsni(n1, _deforest_Cons_head, _deforest_Cons_tail)
    };
    tmp9 = take_inst_11_12_9_tsni(tmp2, tmp8);
    return map_inst_11_12_18_tsni(cse_inst_11_12_8_tsni, tmp9)
  });
  tmp = lambda;
  tmp1 = enumFromTo_inst_11_12_10_tsni(1, n);
  return map_inst_11_12_19_tsni(tmp, tmp1)
};
enumFromTo_inst_11_12_10_tsni = function enumFromTo_inst_11_12_10_tsni(a, b) {
  let scrut, tmp, tmp1, _deforest_Cons_head, _deforest_Cons_tail;
  scrut = a <= b;
  if (scrut === true) {
    tmp = a + 1;
    tmp1 = enumFromTo_inst_11_12_10_tsni(tmp, b);
    _deforest_Cons_head = a;
    _deforest_Cons_tail = tmp1;
    return (f) => {
      let param0, param1, x, xs, tmp2, tmp3;
      ...
      xs = param1;
      tmp2 = runtime.safeCall(f(x));
      tmp3 = map_inst_11_12_19_tsni(f, xs);
      return NofibPrelude.Cons(tmp2, tmp3)
    }
  } else {
    return (f) => {
...
cse_inst_11_12_8_tsni = function cse_inst_11_12_8_tsni(t) {
  let tmp, tmp1;
  tmp = cse.labelTree(t);
  tmp1 = ltGraph_inst_11_12_8_6_tsni(tmp);
  return cse.findCommon(tmp1)
};
ltGraph_inst_11_12_8_6_tsni = function ltGraph_inst_11_12_8_6_tsni(t) {
  let labelOf, param0, param1, first1, first0, n, x, xs, tmp, arr, tmp1, tmp2;
  labelOf = function labelOf(t1) {
    let param01, param11, first11, first01, n1, x1, xs1;
    if (t1 instanceof cse.Node.class) {
  ...
  if (t instanceof cse.Node.class) {
    ...
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      ...
      tmp1 = map_inst_11_12_8_6_1_tsni(ltGraph_inst_11_12_8_6_tsni, xs);
      tmp2 = concat_inst_11_12_8_6_15_tsni(tmp1);
      return NofibPrelude.Cons(arr, tmp2)
    } else {
      throw new globalThis.Error("match error");
    }
...
map_inst_11_12_8_6_1_tsni = function map_inst_11_12_8_6_1_tsni(f, xs) {
  let param0, param1, x, xs1, tmp, tmp1, _deforest_Cons_head, _deforest_Cons_tail;
  if (xs instanceof NofibPrelude.Cons.class) {
    param0 = xs.head;
    param1 = xs.tail;
    ...
    xs1 = param1;
    tmp = runtime.safeCall(f(x));
    tmp1 = map_inst_11_12_8_6_1_tsni(f, xs1);
    _deforest_Cons_head = tmp;
    _deforest_Cons_tail = tmp1;
    return () => {
      let param01, param11, x1, xs2, tmp2;
      ...
      x1 = param01;
      xs2 = param11;
      tmp2 = concat_inst_11_12_8_6_15_tsni(xs2);
      return NofibPrelude.append(x1, tmp2)
    }
  } else if (xs instanceof NofibPrelude.Nil.class) {
    return () => {
...
take_inst_11_12_9_tsni = function take_inst_11_12_9_tsni(n, ls) {
  return runtime.safeCall(ls(n))
};
scanr_inst_13_tsni = function scanr_inst_13_tsni(f, q, ls) {
  return runtime.safeCall(ls(f, q))
};
scanl_inst_14_tsni = function scanl_inst_14_tsni(f, q, ls) {
  return runtime.safeCall(ls(f, q))
};
concat_inst_0_15_tsni = function concat_inst_0_15_tsni(ls) {
  return runtime.safeCall(ls())
};
bind_inst_2_16_tsni = function bind_inst_2_16_tsni(m, f) {
  let lambda;
  lambda = (undefined, function (s) {
    let scrut;
...
bind_inst_2_17_tsni = function bind_inst_2_17_tsni(m, f) {
  let lambda;
  lambda = (undefined, function (s) {
    let scrut;
    scrut = runtime.safeCall(m(s));
...
concat_inst_5_6_15_tsni = function concat_inst_5_6_15_tsni(ls) {
  return runtime.safeCall(ls())
};
concat_inst_7_8_6_15_tsni = function concat_inst_7_8_6_15_tsni(ls) {
  return runtime.safeCall(ls())
};
map_inst_7_18_tsni = function map_inst_7_18_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
map_inst_7_19_tsni = function map_inst_7_19_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
map_inst_11_12_19_tsni = function map_inst_11_12_19_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
concat_inst_11_12_8_6_15_tsni = function concat_inst_11_12_8_6_15_tsni(ls) {
  return runtime.safeCall(ls())
};
map_inst_11_12_18_tsni = function map_inst_11_12_18_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
(class cse {
  static {
    ...
    tmp14 = (f, q) => {
      return match_ls_arm_Cons_inst_14_tsni(f, q, _deforest_Cons_head7, _deforest_Cons_tail7)
    };
    _deforest_Cons_head6 = cse.c;
    _deforest_Cons_tail6 = tmp14;
    tmp15 = (f, q) => {
      return match_ls_arm_Cons_inst_14_tsni(f, q, _deforest_Cons_head6, _deforest_Cons_tail6)
    };
    _deforest_Cons_head5 = cse.b;
    _deforest_Cons_tail5 = tmp15;
    tmp16 = (f, q) => {
      return match_ls_arm_Cons_inst_14_tsni(f, q, _deforest_Cons_head5, _deforest_Cons_tail5)
    };
    _deforest_Cons_head4 = cse.a;
    _deforest_Cons_tail4 = tmp16;
    tmp17 = (f, q) => {
      return match_ls_arm_Cons_inst_14_tsni(f, q, _deforest_Cons_head4, _deforest_Cons_tail4)
    };
    tmp18 = scanl_inst_14_tsni(cse.plus_, cse.zerO, tmp17);
    ...
    tmp20 = (f, q) => {
      return match_ls_arm_Cons_inst_13_tsni(f, q, _deforest_Cons_head3, _deforest_Cons_tail3)
    };
    _deforest_Cons_head2 = cse.c;
    _deforest_Cons_tail2 = tmp20;
    tmp21 = (f, q) => {
      return match_ls_arm_Cons_inst_13_tsni(f, q, _deforest_Cons_head2, _deforest_Cons_tail2)
    };
    _deforest_Cons_head1 = cse.b;
    _deforest_Cons_tail1 = tmp21;
    tmp22 = (f, q) => {
      return match_ls_arm_Cons_inst_13_tsni(f, q, _deforest_Cons_head1, _deforest_Cons_tail1)
    };
    _deforest_Cons_head = cse.a;
    _deforest_Cons_tail = tmp22;
    tmp23 = (f, q) => {
      return match_ls_arm_Cons_inst_13_tsni(f, q, _deforest_Cons_head, _deforest_Cons_tail)
    };
    tmp24 = scanr_inst_13_tsni(cse.plus_, cse.zerO, tmp23);
  ...
  static ltGraph(t2) {
    ...
    if (t2 instanceof cse.Node.class) {
      ...
      if (globalThis.Array.isArray(param0) && param0.length === 2) {
        ...
        tmp1 = map_inst_0_1_tsni(cse.ltGraph, xs3);
        tmp2 = concat_inst_0_15_tsni(tmp1);
        return NofibPrelude.Cons(arr, tmp2)
      } else {
        throw new globalThis.Error("match error");
      }
  ...
  static visited(n) {
    ...
    lambda = (undefined, function (us) {
      ...
      if (scrut === true) {
        ...
        tmp2 = set__inst_2_3_tsni(tmp1);
        lambda1 = (undefined, function (_p) {
          return cse.retURN(false)
        });
        return bind_inst_2_16_tsni(tmp2, lambda1)
      }
    });
    tmp = lambda;
    return bind_inst_2_17_tsni(fetch_inst_2_4_tsni, tmp)
  } 
  ...
  static cse(t3) {
    ...
    tmp1 = ltGraph_inst_5_6_tsni(tmp);
    return cse.findCommon(tmp1)
  } 
  static plus_(x1, y1) {
    let tmp, tmp1;
  ...
  static testCse_nofib(n1) {
    ...
    lambda = (undefined, function (i) {
      ...
      tmp2 = NofibPrelude.intMod(i, 6);
      _deforest_Cons_head5 = cse.example5;
      _deforest_Cons_tail5 = (n2) => {
        return (f10) => {
          return match_xs_arm_Nil_inst_7_18_tsni(f10)
        }
      };
      tmp3 = (n2) => {
        return match_ls_arm_Cons_inst_7_9_tsni(n2, _deforest_Cons_head5, _deforest_Cons_tail5)
      };
      _deforest_Cons_head4 = cse.example4;
      _deforest_Cons_tail4 = tmp3;
      tmp4 = (n2) => {
        return match_ls_arm_Cons_inst_7_9_tsni(n2, _deforest_Cons_head4, _deforest_Cons_tail4)
      };
      _deforest_Cons_head3 = cse.example3;
      _deforest_Cons_tail3 = tmp4;
      tmp5 = (n2) => {
        return match_ls_arm_Cons_inst_7_9_tsni(n2, _deforest_Cons_head3, _deforest_Cons_tail3)
      };
      _deforest_Cons_head2 = cse.example2;
      _deforest_Cons_tail2 = tmp5;
      tmp6 = (n2) => {
        return match_ls_arm_Cons_inst_7_9_tsni(n2, _deforest_Cons_head2, _deforest_Cons_tail2)
      };
      _deforest_Cons_head1 = cse.example1;
      _deforest_Cons_tail1 = tmp6;
      tmp7 = (n2) => {
        return match_ls_arm_Cons_inst_7_9_tsni(n2, _deforest_Cons_head1, _deforest_Cons_tail1)
      };
      _deforest_Cons_head = cse.example0;
      _deforest_Cons_tail = tmp7;
      tmp8 = (n2) => {
        return match_ls_arm_Cons_inst_7_9_tsni(n2, _deforest_Cons_head, _deforest_Cons_tail)
      };
      tmp9 = take_inst_7_9_tsni(tmp2, tmp8);
      return map_inst_7_18_tsni(cse_inst_7_8_tsni, tmp9)
    });
    tmp = lambda;
    tmp1 = enumFromTo_inst_7_10_tsni(1, n1);
    return map_inst_7_19_tsni(tmp, tmp1)
  } 
  static main() {
    let tmp;
    tmp = testCse_nofib_inst_11_12_tsni(6);
