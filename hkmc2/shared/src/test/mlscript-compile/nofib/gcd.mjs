...
let gcd1, g_inst_0_tsni, quotRem_inst_0_1_tsni, quotRem_inst_1_tsni, g_inst_2_tsni, quotRem_inst_2_1_tsni, map_inst_3_tsni, test_inst_4_tsni, enumFromTo_inst_4_5_tsni, gcdE_inst_4_6_tsni, g_inst_4_6_2_tsni, quotRem_inst_4_6_2_1_tsni, enumFromTo_inst_4_7_tsni, map_inst_4_3_tsni, testGcd_nofib_inst_8_tsni, test_inst_8_4_tsni, map_inst_8_4_3_tsni, gcdE_inst_8_4_6_tsni, g_inst_8_4_6_2_tsni, quotRem_inst_8_4_6_2_1_tsni, enumFromTo_inst_8_4_5_tsni, enumFromTo_inst_8_4_7_tsni, map_inst_9_tsni, map_inst_4_9_tsni, map_inst_8_4_9_tsni;
...
quotRem_inst_1_tsni = function quotRem_inst_1_tsni(a, b) {
  let tmp, tmp1, arr, _deforest_Deforest_Arr_2_0, _deforest_Deforest_Arr_2_1;
  tmp = NofibPrelude.intQuot(a, b);
  tmp1 = NofibPrelude.intRem(a, b);
  _deforest_Deforest_Arr_2_0 = tmp;
...
test_inst_4_tsni = function test_inst_4_tsni(d) {
  ...
  tmp4 = lambda;
  tmp5 = lscomp1(ns);
  tmp6 = map_inst_4_3_tsni(tmp4, tmp5);
  tripls = tmp6;
  lambda1 = (undefined, function (caseScrut) {
    return runtime.safeCall(caseScrut())
  });
  tmp7 = lambda1;
  tmp8 = map_inst_4_9_tsni(tmp7, tripls);
  rs = tmp8;
  return gcd.max_(rs)
};
...
gcdE_inst_4_6_tsni = function gcdE_inst_4_6_tsni(x, y) {
  ...
  if (scrut === true) {
    ...
    return g_inst_4_6_2_tsni(arr1, arr2)
  }
};
g_inst_4_6_2_tsni = function g_inst_4_6_2_tsni(u1u2u3, v1v2v3) {
  let first2, first1, first0, u1, u2, u3, first21, first11, first01, v1, v2, v3, scrut, scrut1, arr;
  if (globalThis.Array.isArray(u1u2u3) && u1u2u3.length === 3) {
    first0 = u1u2u3[0];
    first1 = u1u2u3[1];
    ...
    if (globalThis.Array.isArray(v1v2v3) && v1v2v3.length === 3) {
      ...
      if (scrut1 === true) {
        ...
        scrut = quotRem_inst_4_6_2_1_tsni(u3, v3);
        return runtime.safeCall(scrut(u1, u2, v1, v2, v3))
      }
    } else {
      throw new globalThis.Error("match error");
...
quotRem_inst_4_6_2_1_tsni = function quotRem_inst_4_6_2_1_tsni(a, b) {
  let tmp, tmp1, arr, _deforest_Deforest_Arr_2_0, _deforest_Deforest_Arr_2_1;
  tmp = NofibPrelude.intQuot(a, b);
  tmp1 = NofibPrelude.intRem(a, b);
  _deforest_Deforest_Arr_2_0 = tmp;
...
testGcd_nofib_inst_8_tsni = function testGcd_nofib_inst_8_tsni(x) {
  return test_inst_8_4_tsni(x)
};
test_inst_8_4_tsni = function test_inst_8_4_tsni(d) {
  let lscomp1, ns, ms, tripls, rs, tmp, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7, tmp8, lambda, lambda1;
  lscomp1 = function lscomp1(p1) {
    return runtime.safeCall(p1(lscomp1, ms))
  };
  tmp = 5000 + d;
  tmp1 = enumFromTo_inst_8_4_7_tsni(5000, tmp);
  ns = tmp1;
  tmp2 = 10000 + d;
  tmp3 = enumFromTo_inst_8_4_5_tsni(10000, tmp2);
  ms = tmp3;
  lambda = (undefined, function (caseScrut) {
    return runtime.safeCall(caseScrut())
  });
  tmp4 = lambda;
  tmp5 = lscomp1(ns);
  tmp6 = map_inst_8_4_3_tsni(tmp4, tmp5);
  tripls = tmp6;
  lambda1 = (undefined, function (caseScrut) {
    return runtime.safeCall(caseScrut())
  });
  tmp7 = lambda1;
  tmp8 = map_inst_8_4_9_tsni(tmp7, tripls);
  rs = tmp8;
  return gcd.max_(rs)
};
map_inst_8_4_3_tsni = function map_inst_8_4_3_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
gcdE_inst_8_4_6_tsni = function gcdE_inst_8_4_6_tsni(x, y) {
  let scrut, arr, arr1, arr2;
  scrut = x == 0;
  if (scrut === true) {
    arr = [
    ...
    return g_inst_8_4_6_2_tsni(arr1, arr2)
  }
};
g_inst_8_4_6_2_tsni = function g_inst_8_4_6_2_tsni(u1u2u3, v1v2v3) {
  let first2, first1, first0, u1, u2, u3, first21, first11, first01, v1, v2, v3, scrut, scrut1, arr;
  if (globalThis.Array.isArray(u1u2u3) && u1u2u3.length === 3) {
    first0 = u1u2u3[0];
    first1 = u1u2u3[1];
    ...
    if (globalThis.Array.isArray(v1v2v3) && v1v2v3.length === 3) {
      ...
      if (scrut1 === true) {
        ...
        scrut = quotRem_inst_8_4_6_2_1_tsni(u3, v3);
        return runtime.safeCall(scrut(u1, u2, v1, v2, v3))
      }
    } else {
      throw new globalThis.Error("match error");
...
quotRem_inst_8_4_6_2_1_tsni = function quotRem_inst_8_4_6_2_1_tsni(a, b) {
  let tmp, tmp1, arr, _deforest_Deforest_Arr_2_0, _deforest_Deforest_Arr_2_1;
  tmp = NofibPrelude.intQuot(a, b);
  tmp1 = NofibPrelude.intRem(a, b);
  _deforest_Deforest_Arr_2_0 = tmp;
...
enumFromTo_inst_8_4_5_tsni = function enumFromTo_inst_8_4_5_tsni(a, b) {
  let scrut, tmp, tmp1, _deforest_Cons_head, _deforest_Cons_tail;
  scrut = a <= b;
  if (scrut === true) {
    tmp = a + 1;
    tmp1 = enumFromTo_inst_8_4_5_tsni(tmp, b);
    _deforest_Cons_head = a;
    _deforest_Cons_tail = tmp1;
    return (lscomp2, lscomp1, h1, t1) => {
      let param0, param1, h2, t2, arr, tmp2, _deforest_Cons_head1, _deforest_Cons_tail1, _deforest_Deforest_Arr_2_0, _deforest_Deforest_Arr_2_1;
      ...
      return (f) => {
        ...
        return (f1) => {
          ...
          xs = param11;
          tmp3 = runtime.safeCall(f1(x));
          tmp4 = map_inst_8_4_9_tsni(f1, xs);
          return NofibPrelude.Cons(tmp3, tmp4)
        }
      }
    }
...
enumFromTo_inst_8_4_7_tsni = function enumFromTo_inst_8_4_7_tsni(a, b) {
  let scrut, tmp, tmp1, _deforest_Cons_head, _deforest_Cons_tail;
  scrut = a <= b;
  if (scrut === true) {
    tmp = a + 1;
    tmp1 = enumFromTo_inst_8_4_7_tsni(tmp, b);
    _deforest_Cons_head = a;
    _deforest_Cons_tail = tmp1;
    return (lscomp1, ms) => {
      let lscomp2, param0, param1, h1, t1;
...
map_inst_4_9_tsni = function map_inst_4_9_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
map_inst_8_4_9_tsni = function map_inst_8_4_9_tsni(f, xs) {
  return runtime.safeCall(xs(f))
};
(class gcd {
  static {
    ...
    if (globalThis.Array.isArray(u1u2u3) && u1u2u3.length === 3) {
      ...
      if (globalThis.Array.isArray(v1v2v3) && v1v2v3.length === 3) {
        ...
        if (scrut1 === true) {
          ...
          scrut = quotRem_inst_1_tsni(u3, v3);
          return runtime.safeCall(scrut(u1, u2, v1, v2, v3))
        }
      } else {
        throw new globalThis.Error("match error");
  ...
  static test(d) {
    ...
    lscomp1 = function lscomp1(p1) {
      ...
      if (p1 instanceof NofibPrelude.Nil.class) {
        ...
        t1 = param1;
        lscomp2 = function lscomp2(p2) {
          let param01, param11, h2, t2, arr, tmp9;
    ...
    ms = tmp3;
    lambda = (undefined, function (caseScrut) {
      let first1, first0, x1, y1, tmp9, arr;
    ...
    tmp4 = lambda;
    tmp5 = lscomp1(ns);
    tmp6 = map_inst_3_tsni(tmp4, tmp5);
    tripls = tmp6;
    lambda1 = (undefined, function (caseScrut) {
    ...
    tmp7 = lambda1;
    tmp8 = map_inst_9_tsni(tmp7, tripls);
    rs = tmp8;
    return gcd.max_(rs)
  } 
  static testGcd_nofib(x1) {
    return test_inst_4_tsni(x1)
  } 
  static main() {
    return testGcd_nofib_inst_8_tsni(40)
  }
